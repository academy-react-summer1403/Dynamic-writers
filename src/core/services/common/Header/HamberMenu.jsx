...
const HamberMenu = ({ isOpen, onOpenChange }) => {
    ...
    <div className='border-2 w-10 mx-auto cursor-pointer'></div>
      <div className='w-full flex flex-col gap-6 p-5'>
        <div className='text-sm flex flex-row-reverse justify-between w-full'>
            ...
            <span className='text-gray-400 text-xs w-36 overflow-hidden h-6 text-ellipsis whitespace-nowrap'> صفحه اصلی </span>
        </div>
        <div className='text-sm flex flex-row-reverse justify-between w-full'>
            ...
            <span className='text-gray-400 text-xs w-36 overflow-hidden h-6 text-ellipsis whitespace-nowrap' dir='rtl'> تمامی دوره های برگزار شده یا درحال برگزاری </span>
        </div>
        <div className='text-sm flex flex-row-reverse justify-between w-full'>
            ...
            <span className='text-gray-400 text-xs w-36 overflow-hidden h-6 text-ellipsis whitespace-nowrap' dir='rtl'> خبر های پژوهشگاه و مقالاتی مرتبط با برنامه نویسی و ... </span>
        </div>
        <div className='text-sm flex flex-row-reverse justify-between w-full'>
