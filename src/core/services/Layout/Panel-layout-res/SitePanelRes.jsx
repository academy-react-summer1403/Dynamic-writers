...
const SitePanelRes = ({ profileInfo }) => {
  ...
  return (
    ...
    <div dir='ltr' className={`flex items-center flex-row-reverse justify-between p-2 mt-10 dark:bg-slate-600 gap-4 bg-white shadow-2xl rounded-3xl lg:hidden z-40 fixed w-11/12 bottom-1 right-4`}>
      ...
      <NavLink to='/layoutPanel/profile' className='rounded-full size-12 bg-red-300 cursor-pointer'>
        <img src={profileInfo.currentPictureAddress} className='w-full h-full rounded-full' />
      </NavLink>
