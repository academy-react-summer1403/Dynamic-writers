...
const SitePanelRes = () => {
  ...
  return (
    ...
    <div className={`flex items-center flex-row-reverse justify-between my-5 p-2 dark:bg-slate-600 gap-4 bg-white shadow-xl rounded-3xl lg:hidden z-40  fixed w-11/12 bottom-2 right-4`}>
