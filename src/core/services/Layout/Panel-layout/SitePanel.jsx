      ...
      <div className='flex flex-col gap-12'>
        ...
        <div className='flex flex-col w-full h-fit gap-10 justify-center' dir='rtl'>
          <div className='flex flex-col w-full h-fit gap-3 font-semibold justify-center'>
              ...
              <NavLink to='profile/profileInfo' className={({isActive}) => isActive ? "bg-blue-500 hover:bg-blue-300 text-white w-full h-10 flex items-center px-3 rounded-3xl flex-row-reverse gap-3 justify-end" : "bg-white hover:bg-gray-200 text-black w-full h-10 flex items-center px-3 rounded-3xl flex-row-reverse gap-3 justify-end" }> پروفایل <UserEdit01Icon /> </NavLink>
