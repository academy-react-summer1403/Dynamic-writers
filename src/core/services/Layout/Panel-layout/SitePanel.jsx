...
import { Book02Icon, BookBookmark02Icon, Invoice02Icon,Bookmark02Icon, DashboardCircleIcon, DashboardCircleSettingsIcon, FileBookmarkIcon, Logout03Icon, MoneySend01Icon, MoneySend02Icon, SecurityIcon, TimeSetting02Icon, TimeSetting03Icon, UserEdit01Icon, UserSettings01Icon } from 'hugeicons-react'
  ...
  return (
    <div className='dark:bg-slate-700 dark:text-white bg-white rounded-2xl gap-5 lg:flex flex-col min-w-[276px] h-dvh py-7 px-6 justify-between hidden'>
      ...
      <div className='flex w-full h-fit gap-4 flex-col'>
        <NavLink to={'multiAccounts'} className='hover:bg-blue-700 dark:bg-slate-900 dark:text-white dark:border-none hover:text-white bg-white border w-full p-2 rounded-full flex text-right text-lg justify-end gap-4 font-semibold flex-row-reverse'>  حساب‌های کابری <UserSettings01Icon /> </NavLink>
