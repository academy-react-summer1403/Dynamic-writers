  ...
  return (
    <div className='dark:bg-slate-700 dark:text-white bg-white rounded-2xl lg:flex flex-col py-7 px-6 justify-between hidden'>
      ...
      <div className='flex w-full h-fit gap-4 flex-col mt-16'>
        <NavLink onClick={() => navigate('')} className='hover:bg-blue-700 dark:bg-slate-900 dark:text-white dark:border-none hover:text-white bg-white border w-full p-2 rounded-full flex text-right text-lg justify-end gap-4 font-semibold'>  حساب‌های کابری <UserSettings01Icon /> </NavLink>
