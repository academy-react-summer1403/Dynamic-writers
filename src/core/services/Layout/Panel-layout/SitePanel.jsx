...
import { Book02Icon, Invoice02Icon,Bookmark02Icon, DashboardCircleIcon, FileBookmarkIcon, Logout03Icon, SecurityIcon, TimeSetting03Icon, UserEdit01Icon, UserSettings01Icon, JobLinkIcon, TimeScheduleIcon, AssignmentsIcon } from 'hugeicons-react'
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='flex flex-col w-full h-fit gap-6 justify-center' dir='rtl'>
          <div className='flex flex-col w-full h-fit gap-3 font-semibold justify-center'>
              ...
              <NavLink to='homeWorks' className={({isActive}) => isActive ? "bg-blue-500 hover:bg-blue-300 text-white w-full h-10 flex items-center px-3 rounded-3xl flex-row-reverse gap-3 justify-end" : "bg-white dark:bg-slate-900 dark:text-white hover:bg-gray-200 text-black w-full h-10 flex items-center px-3 rounded-3xl flex-row-reverse gap-3 justify-end" }> تکالیف <AssignmentsIcon /> </NavLink>
