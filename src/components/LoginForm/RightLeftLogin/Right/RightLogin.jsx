...
const RightLogin = () => {
  return (
    <div className='grow-5 bg-gray-200 dark:bg-slate-600 md:flex justify-start items-end h-dvh py-7 flex-col hidden'>
        ...
        <div className='flex items-center w-4/6 h-14' style={{direction : 'rtl'}} >
            ...
            <span className='inline text-sm font-semibold mr-5 text-gray-700 w-52' style={{direction: 'rtl'}} > تایید کد ارسال شده
