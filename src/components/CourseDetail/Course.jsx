...
const Course = () => {
  ...
  return (
    <Fragment>
        ...
        <div className='flex w-[100%] justify-around p-5 pt-20 gap-5 flex-row-reverse  max-md:flex-col max-lg:flex-col items-center lg:items-start  max-xl:justify-evenly xl:items-start  max-2xl:justify-evenly'>
