...
const isClick=()=>{
  ...
  return (
    <div className='h-[550px] w-[500px] border-4 border-solid border-[#E4E4E4] rounded-[24px] items-end  flex flex-col  gap-8 p-5 max-sm:w-[100%] max-md:w-[100%] max-lg:w-[80%] relative lg:sticky top-10 max-xl:w-[500px]  xl:sticky max-2xl:w-[500px]' >
