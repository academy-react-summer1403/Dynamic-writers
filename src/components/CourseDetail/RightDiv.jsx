...
const isClick=()=>{
  ...
  return (
    <div className='h-[550px] w-[500px] border-4 border-solid border-[#E4E4E4] rounded-[24px]  items-end  flex flex-col gap-8 p-5 max-2xl:w-[500px] max-xl:w-[500px] max-md:w-[100%] max-sm:w-[100%] sticky top-10' >
