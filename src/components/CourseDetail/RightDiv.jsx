...
const RightDiv = ({Course,FlagModal,open}) => {
  ...
  return (
    <motion.div whileInView={{x: 0}} initial={{x: 300}} transition={1} className='h-fit w-[500px] border-4 border-solid dark:text-white border-[#E4E4E4] rounded-[24px] items-end  flex flex-col md:w-[30%] gap-8 p-5 max-sm:w-[100%] max-md:w-[100%] max-xl:w-[50%]  xl:sticky  max-lg:w-[80%] relative top-[-10px] lg:sticky md:top-10 max-2xl:w-[500px]' >
