...
const FilterCourse = () => {
  return (
    <div className='bg-gray-100 rounded-3xl w-80 p-5 flex flex-col gap-5 font-semibold' style={{height: '700px'}}>
    ...
    <div className='relative flex flex-col gap-3'>
          ...
          <Input type='search' name='search' className='w-full my-2 rounded-xl bg-gray-200 !important'  placeholder='جستجو کنید...' dir='rtl' endContent={
                      <button type='submit' className='text-white bg-blue-500 absolute rounded-2xl h-10 w-10 left-0 text-center flex justify-center items-center hover:bg-blue-400'> <Search01Icon className='size-5' /> </button>
          }/>
    ...
    <div className='flex flex-row-reverse gap-14'>
        ...
        <h2 className='font-semibold'> 10,000 </h2>
        </div>
        <div className='flex gap-1 flex-row-reverse'>
        <span className='text-gray-500'> تا </span>
        <h2 className='font-semibold'> 1,000,000 </h2>
        </div>
    </div>
    </div>

    <div className='flex flex-row-reverse'>
    <input type='range' min='0' max='9999999' step='100000' className='border-none cursor-pointer bg-gray-200 w-36 h-2 rounded-full appearance-none thump' />
