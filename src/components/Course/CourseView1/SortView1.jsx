        ...
        <div className='flex gap-2 flex-row-reverse'>
          ...
          <label onClick={() => {changeView('view2')}} htmlFor='view2' className='labelView'> <Layout3RowIcon className='size-5' /> </label>
            ...
            <div className='flex gap-4 flex-row-reverse items-center'>
                ...
                <label onClick={() => {updateParams('', '')}} htmlFor='sort4' className='group hover:bg-red-500 hover:text-white border py-1.5 px-3 border-red-500 text-red-500 rounded-full bg-white flex flex-row-reverse items-center gap-2 text-sm cursor-pointer'>
