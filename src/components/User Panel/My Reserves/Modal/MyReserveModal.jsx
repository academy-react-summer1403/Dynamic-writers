      ...
      {(onClose) => (
        ...
        <ModalBody>
                ...
                <div className='w-full h-[287px] bg-[#E8E8E8] rounded-[16px] relative'>
                    <img src='' className='w-full h-full rounded-[16px]' />
                </div>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <span className='text-[24px] font-bold'> {courseName} </span>
                </div>
                ...
                <div className='flex flex-col gap-4 my-2'>
                    <div className='flex gap-4'> <Calendar01Icon /> <span className='flex flex-row-reverse gap-1'> <span className='text-gray-400'> (شروع) </span> {jMoment(reserverDate).locale('fa').format('jD jMMMM jYYYY')} </span> </div>
                </div>
