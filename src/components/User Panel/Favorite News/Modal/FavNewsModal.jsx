        ...
        <ModalBody>
                ...
                <div className='w-full h-fit flex justify-between items-center'>
                    ...
                    <div className='flex gap-2 items-center h-full w-fit'>
                        <button className='border-2 flex justify-center items-center bg-white rounded-full size-14 min-w-14 min-h-14 hover:bg-blue-300'> <ThumbsDownIcon onClick={Dislike} className={`${dislike ? 'text-red-500' : 'text-black'} size-6`} /> </button>
                        <button className='border-2 flex justify-center items-center bg-white rounded-full size-14 min-w-14 min-h-14 hover:bg-blue-300'> <ThumbsUpIcon onClick={Like} className={`${like ? 'text-red-500' : 'text-black'} size-6`} /> </button>
                    </div>
                </div>
                ...
                <div className='flex flex-col gap-4 my-2'>
                    ...
                    <span className='text-[16px] text-[#272727] h-[46px] overflow-hidden' dir='rtl'> {News.describe} </span>
                </div>
                <div className='flex flex-col gap-4 my-2'>
