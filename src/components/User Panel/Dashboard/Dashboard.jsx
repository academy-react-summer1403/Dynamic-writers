import { ArrowLeft01Icon, Calendar03Icon, Clock01Icon, PencilEdit01Icon } from 'hugeicons-react'
  ...
  return (
    <div className='flex p-2 flex-col gap-3 rounded-2xl h-full' dir='rtl'>
      <div className='h-full w-full flex flex-col gap-5 iranSans'>
        ...
        <div className='w-full flex flex-col md:flex-row gap-8 md:h-[288px] h-full' dir='rtl'>
          <div className='md:h-full overflow-hidden md:w-[580px] w-full bg-white dark:bg-slate-700 dark:text-white rounded-2xl py-3 px-4'>
            <div className='flex w-full justify-between'>
              <h2 className='text-base font-semibold'> نظرات شما </h2>
              <button onClick={onOpen} className='flex items-center text-blue-500 text-sm font-semibold'> مشاهده همه <ArrowLeft01Icon className='size-4'/> </button>
            </div>
          ...
          <I18nProvider locale='fa-IR'>
            <Calendar
              ...
              className='shadow-none h-full md:block hidden'
          ...
          <div className='md:h-full h-72 dark:bg-slate-700 w-full md:w-[300px] dark:text-white bg-white rounded-2xl py-3 px-4 flex flex-col justify-between'>
