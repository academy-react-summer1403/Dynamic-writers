            ...
            <ModalContent>
                {(onClose) => (
                    <>
                        ...
                        <ModalBody>
                            <Tabs classNames={{
                                tabList: 'rounded-full p-0 iranSans',
                                tab: 'rounded-full border-none text-gray-600 dark:text-white iranSans',
                                tabContent: 'iranSans',
                                cursor: 'bg-blue-500 rounded-full iranSans',
                                panel: 'text-white iranSans',
                            }}>
                                    ...
                                    <Card>
                                        <CardBody>
                                            <div className='w-full h-fit flex flex-col overflow-hidden gap-8'>
                                                ...
                                                {commentsNew[0] == undefined && <span className='mx-auto h-[300px] text-[30px] text-gray-400 font-semibold flex items-center'> نظری ثبت نشده است </span>}
                                            </div>
                                        </CardBody>
                                    </Card>
                                </Tab>
