  ...
  return (
    <div className='grow-5 bg-gray-200 dark:bg-slate-800 px-5 md:flex justify-start items-end h-dvh py-7 flex-col hidden'>
        ...
        <div className='flex items-center w-4/6 h-14' style={{direction : 'rtl'}} >
            <div className='block size-12 min-w-14 min-h-14 bg-white rounded-full flex items-center'> <PasswordValidationIcon className='m-auto text-gray-700'/> </div>
        ...
        <div className='flex items-center w-4/6 h-14 my-6' style={{direction : 'rtl'}} >
            <div className='block size-12 min-w-14 min-h-14 bg-white rounded-full flex items-center'> <UserAccountIcon className='m-auto text-gray-700'/> </div>
