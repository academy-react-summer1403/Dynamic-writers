...
const CoursesView1 = ({levelName, id, title, describe, dissLikeCount, likeCount, cost, teacherName, date, currentUserRateNumber, typeName, tumbImageAddress, statusName}) => {

  const navigate = useNavigate()
  
  return (
    <div onClick={() => navigate('/CourseDetail/' + id)} className='rounded-2xl bg-gray-200 iranSans flex flex-col justify-between font-semibold' style={{height: '512px', width: '315px'}}>
