...
const CoursesView1 = ({isLoaded ,levelName, id, title, describe, dissLikeCount, likeCount, cost, teacherName, date, currentUserRateNumber, typeName, tumbImageAddress, statusName}) => {
  ...
  return (
    ...
    <div onClick={() => navigate('/CourseDetail/' + id)} className='rounded-2xl cursor-pointer bg-gray-200 dark:bg-slate-900 dark:text-white h-full w-full w-[315px] dark:border-none iranSans flex flex-col justify-between font-semibold'>
