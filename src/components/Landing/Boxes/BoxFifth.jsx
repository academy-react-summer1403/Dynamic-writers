...
const BoxFifth = () => {
    ...
    return (
        <>
       <Card classNames={{base: 'shadow-none'}} className='bg-transparent my-10 w-full flex-wrap mx-auto flex gap-2 justify-center md:justify-between items-center flex-row overflow-hidden md:overflow-visible' 
