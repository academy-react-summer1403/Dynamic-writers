        ...
        <div className='relative flex'>
            ...
            >
                ...
                <Form>
                    ...
                    <Field type='search' name='Query' className='font-bold text-xs h-9 w-40 rounded-xl bg-gray-200 text-sm dark:bg-slate-800 text-gray-700 px-2 outline-none'  placeholder='جست جو کنید...' dir='rtl'/>
