...
const NewsItem = ({ id, title, miniDescribe, currentImageAddressTumb, currentView }) => {
  return (
    <div className='flex bg-gray-100 rounded-3xl h-72 flex-row-reverse' style={{width: '985px'}}>
      <div className='bg-red-300 h-full w-5/12 rounded-3xl relative'>
        ...
        <div className='h-fit w-fit absolute top-2 right-2 flex gap-2 flex-row-reverse'>
            <div className='bg-blue-500 w-fit text-white rounded-full px-3 py-1 shadow-lg text-sm font-bold'> مقاله </div>
            <div className='bg-blue-500 w-fit text-white rounded-full px-3 py-1 shadow-lg text-sm font-bold'> برنامه نویسی </div>
        </div>
      </div>
      <div className='flex flex-col gap-4 p-3 w-7/12 items-end justify-between'>
        <h2 className='text-2xl iranSansBold'> {title} </h2>
        ...
        <div className='flex flex-col gap-4 items-end'>
            <div className='flex gap-4 flex-row-reverse items-center'>
                <QuillWrite02Icon />
                <span className='font-semibold text-sm'> سعید قربانی </span>
            </div>
            <div className='flex gap-4 flex-row-reverse items-center'>
                <ViewIcon />
            ...
            <div className='flex gap-4 flex-row-reverse items-center'>
                <Calendar01Icon />
                <span className='font-semibold text-sm'> 1403 اردیبهشت 1 </span>
            </div>
        </div>
        ...
        <div className='w-full flex justify-between items-center'>
            ...
            <div className='flex w-fit h-fit gap-8 flex-row-reverse items-center'>
                <div className='flex gap-4 flex-row-reverse font-semibold text-sm items-center'> <ThumbsUpIcon /> 20 </div>
                <div className='flex gap-4 flex-row-reverse font-semibold text-sm items-center'> <ThumbsDownIcon /> 1 </div>
            </div>
        </div>
      </div>
    </div>
