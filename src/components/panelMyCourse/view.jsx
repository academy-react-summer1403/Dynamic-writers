...
import CustomModalStyles from './customModalStyles.module.css';
...
const ViewCard = (props) => {
  ...
  return(
       ...
       <ModalBody>
              ...
              <span className="block text-base text-slate-500">وضعیت پرداختی</span>
              <div>
                  <div className="flex">
                     <div className='flex text-base font-bold' style={{lineHeight: "95px", textIndent: "20px"}}>
                       <div className="mt-4" style={{ width: "72px", height: "72px" }}>
                            <CircularProgressbar 
                            value={66}
                            text={`${66}%`}
                            styles={buildStyles({
                     ...
                     <div className='font-semibold text-xl mt-8 absolute left-4'>{(parseInt(price).toLocaleString("en-US"))} / 1,800,000 <span className="text-blue-700">تومان</span></div>
                  </div>
              </div>
