...
import { Link } from 'react-router-dom';
  ...
  const RightResetPass1 = () => {
    return (
      <div className='grow-5 dark:bg-slate-800 px-5 bg-gray-200 md:flex justify-start items-end h-dvh py-7 flex-col hidden'>
  ...
  export default RightResetPass1
