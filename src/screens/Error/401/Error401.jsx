  ...
  return (
    <div className='flex w-dvw h-fit py-32'>
      <div className='mx-auto h-fit w-fit flex gap-6 font-semibold flex-col items-center relative'>
        <h2 className='text-3xl font-semibold text-blue-500'> حساب نداری 😏 </h2>
        <span className='text-blue-500 w-60 text-center' dir='rtl'> شما به حساب کاربری خود وارد نشدید. برای دسترسی بیشتر به سایت باید اول وارد حساب کاربری خودتون بشید !</span>
        <div className='flex gap-5'>
            <Button onClick={() => navigate('/')} className='font-semibold text-sm text-white bg-blue-500 rounded-full'> صفحه اصلی </Button>
            <Button onClick={() => navigate('/login')} className='font-semibold text-sm text-blue-500 bg-white border border-blue-500 rounded-full dark:border-none dark:text-white dark:bg-slate-800'> حساب کاربری </Button>
        </div>
