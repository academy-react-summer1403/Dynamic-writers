  ...
  return (
    <div className='flex w-dvw h-fit py-32'>
      <div className='mx-auto h-fit w-fit flex gap-6 font-semibold flex-col items-center relative'>
        <span className='text-[30px] font-semibold text-blue-500' dir='rtl'> <h5 className='text-sm rotate-12 w-fit'> 403 </h5> دسترسی نداری 😎 </span>
        <span className='text-blue-500 w-60 text-base text-center'> شما دسترسی لازم برای این عملیات را نداری  </span>
